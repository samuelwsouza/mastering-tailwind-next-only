...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="flex flex-col flex-1 cursor-pointer items-center gap-3 rounded-lg shadow-sm border border-zinc-300 px-6 py-4 text-center text-zinc-500 group hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
    >
