      ...
      {state === "error" ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm font-normal text-error-600 dark:text-error-500">
              {name}
            </span>
          </div>
          ...
          <button
            type="button"
            className="text-sm font-semibold text-error-700 hover:text-error-900 dark:hover:text-error-300"
          >
            Try again
          </button>
        </div>
